...
public class FoodBevFragment extends android.support.v4.app.Fragment {
    ListView listView ;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        list.add(new CustomClass("Outdoor Catering", "","", "", "Starting at Rs.500")) ;
        list.add(new CustomClass("Dining Expenses", "", "", " ", " Starting at Rs.900")) ;
