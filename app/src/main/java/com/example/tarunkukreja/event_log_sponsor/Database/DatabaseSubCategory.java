...
public class DatabaseSubCategory extends SQLiteOpenHelper {


    public static String TAG = DatabaseSaveDetails.class.getSimpleName();
    private static final int DATABASE_VERSION = 1;
    // Database Name
    private static final String DATABASE_NAME = "EventMosaicSubCategory";
    // tasks table name
    private static final String TABLE_QUEST = "SubCategory";
    ...
    public DatabaseSubCategory(Context context) {
    ...
    public void createActivity(String question, String category, String option) {
    ...
    public ArrayList<SubCategory> getAllQuestions(String category) {
        ArrayList<SubCategory> quesList = new ArrayList<SubCategory>();
        // Select All Query
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                SubCategory quest = new SubCategory();
    ...
    public void addQuestionsData() {
        ...
        String[] key1 = {"Food catering service", "Beverages", "Both"};


        createActivity("What are you looking for ?", "Food & Beverages", addCategoryQuestion(key1));


        String[] key2 = {"Photographer", "VideoGrapher"};


        createActivity("Are you looking for ?", "Photography & Videography", addCategoryQuestion(key2));


    }


    private String addCategoryQuestion(String[] value) {
...
//
//
//        SubCategory q1 = new SubCategory("What are you looking for ?", "Food & Beverage",  addCategoryQuestion(key1));
//        this.addQuestion(q1);
//
//
//        String[] key2 = {"Photographer", "VideoGrapher"};
...
//
//
//        SubCategory q2 = new SubCategory("Are you looking for ?", "Photography & Videography",  addCategoryQuestion(key2));
//        this.addQuestion(q2);
//
//
...
//
//    // Adding new question
//    public void addQuestion(SubCategory quest) {
//
//        SQLiteDatabase db = this.getWritableDatabase();
//        ContentValues values = new ContentValues();
